...
- (instancetype)initWithStyle:(UITableViewCellStyle)style
    ...
    if (self) {
        ...
        // Marge haute fixe 4pt dans la cellule ; marge basse variable gérée
        // dans s7tv_heightForMessage: (lineSpacing) — voir là-bas.
...
// Hauteur exacte mise en cache par messageID.
//
// Marge totale = 4 (haut, fixe, voir S7TVChatCustomCell) + lineSpacing
// (bas, réglable via le picker / SevenTVChatAppearanceConfig). Avec le
// défaut lineSpacing=4, le total reste 8pt, identique à l'ancien
// comportement — donc aucun changement visuel tant que la personne ne
// touche pas au slider.
- (CGFloat)s7tv_heightForMessage:(S7TVChatMessage *)msg {
    ...
    // 4 = marge haute fixe ; lineSpacing = espacement réglable entre 2
    // messages (marge basse). ceil() : ne jamais couper un pixel de la
    // dernière ligne.
