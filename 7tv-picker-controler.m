...
- (void)_createEmotePickerViewWithFrame:(CGRect)frame {
    ...
    UIColor *bgColor    = [UIColor colorWithRed:0.055 green:0.055 blue:0.071 alpha:1.0]; // #0E0E10 (blue compensé +2/255, rendu réel confirmé -2 par mesure pixel screenshot)
