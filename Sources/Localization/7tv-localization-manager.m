...
- (void)s7tv_buildTable {
    _table = @{
        ...
        @"adblock_proxy_builtin":            @[@"Proxy intégré", @"Built-in proxy"],
        ...
        @"menu_adblock_subtitle":           @[@"Proxy ou VAFT", @"Proxy or VAFT"],
        ...
        @"setting_chat_top_banners":         @[@"Éléments du chat à masquer", @"Chat elements to hide"],
        @"setting_chat_top_banners_none":    @[@"Aucun élément masqué", @"No elements hidden"],
        @"chat_top_hide_messages_announcements": @[@"Messages épinglés et annonces", @"Pinned messages and announcements"],
        @"chat_top_hide_goals_leaderboard": @[@"Objectifs du créateur et classement", @"Creator goals and leaderboard"],
