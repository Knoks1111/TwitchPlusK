...
// (bas, réglable via le picker / SevenTVChatAppearanceConfig). Par défaut
// lineSpacing=6 → total 10pt.
...
- (NSAttributedString *)s7tv_buildAttributedStringForMessage:(S7TVChatMessage *)msg
    ...
    // NB : les badges gardent volontairement leur position verticale actuelle
