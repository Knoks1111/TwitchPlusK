 ...
 *  - s7tv_swizzle_orientation_lock() — appelé depuis le constructeur (no-op :
 *     les swizzles orientation s'installent à la demande, au premier lock)
 */
...
// de TweakSevenTV.m (elle n'y était utilisée que par ce module).
